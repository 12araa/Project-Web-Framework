...
@section('content')
    ...
    <div class="card">
        <div class="card-header">
            <h3 class="card-title">Halaman Data Barang</h3>
        </div>
        ...
        <div class="card-body">
            <div class="row mb-3">
                ...
                <div class="col-md-6">
                    <form action="{{ route('barang_index') }}" method="GET">
                        <div class="input-group">
                            ...
                            <div class="input-group-append">
                                ...
                                @if(request('search'))
                                    <a href="{{ route('barang_index') }}" class="btn btn-outline-danger">
                                        Reset
                                    </a>
                                @endif
                            </div>
                    ...
                    <tbody>
                        @forelse($barang as $i => $d)
                            <tr>
                                ...
                                <td>
                                    <a href="{{ route('barang_show', $d->id) }}" class="btn btn-info btn-sm">
                                        Detail
                                    </a>
                                    <a href="{{ route('barang_edit', $d->id) }}" class="btn btn-warning btn-sm">
                                        Edit
                                    </a>
